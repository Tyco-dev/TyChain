...
class Block:
    """
    Block: a uit of storage.
    Store transactions in a blockchain that supports crypto currency.
    """
    ...
    def mine_block(last_block, data):
        """
        Mine a block based on given last_block and data, until a block has is found that meets
        ...
        """
        keep executing a loop until we have a hash value where a substring from 0 up to the difficulty in terms of
        a slice of its characters, is equal 0 times the difficulty.
        Generates a string with the proper number of LEADING 0's that you need to find in the hash
        """
